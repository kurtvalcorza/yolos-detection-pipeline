...
- Snapshot manifest: `weights/yolos-small/dimer-base-manifest.json`, 4 files, `totalBytes` 122771871. The byte sizes are the ones the Hub reported for its `main` branch when this repository was built.
- `model.safetensors`: 122,763,274 bytes; SHA-256 not yet recorded.
