...
The upstream snapshot is pinned to `3d8f7130d3ce4907cb206fe1c8485dc8fe8703de` and the notebook is regenerated with that revision and manifest, so it can run; no execution is recorded yet.
